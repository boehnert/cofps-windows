...
#This script is used to delete the map service
# called from cofps_webService.py and cofps_Fire_webService.py
# example resp = deleteMapService.main(service)
#returns resp  True (good) or False (error)
