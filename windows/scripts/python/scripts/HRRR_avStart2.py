...
avvarList = ["Updrafts_Downdrafts","Turbulence","Horizontal_WindShear"]


def main(logFile):
    try:
        statement = "HRRR_avStart2.py is called "
        print statement
        ...
        for v in avvarList :
            ...
            if v == "Turbulence":
                ...
                templateMap =os.path.join(mxdDir, "max_updraftTemplate.mxd") 
